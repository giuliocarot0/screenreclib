...
\DoxyCodeLine{56     \textcolor{keywordtype}{int} den;}
...
\DoxyCodeLine{100    \textcolor{keywordtype}{char}* filename;}
\DoxyCodeLine{101 }
\DoxyCodeLine{102 \}\mbox{\hyperlink{struct_b}{SRConfiguration}};}
\DoxyCodeLine{103 }
\DoxyCodeLine{104 \textcolor{keyword}{static} \mbox{\hyperlink{struct_s}{SRResolution}} rescale\_resolution(\mbox{\hyperlink{struct_s}{SRResolution}} input, \mbox{\hyperlink{struct_v}{SRResolutionRational}} rescaler)\{}
\DoxyCodeLine{105     \mbox{\hyperlink{struct_s}{SRResolution}}  out;}
\DoxyCodeLine{106     out.width = floor(input.width* rescaler.width.num / rescaler.width.den);}
\DoxyCodeLine{107     out.height = floor(input.height* rescaler.height.num / rescaler.height.den);}
\DoxyCodeLine{108     \textcolor{keywordflow}{return} out;}
\DoxyCodeLine{109 \}}
\DoxyCodeLine{110 }
\DoxyCodeLine{111 \textcolor{keyword}{static} \mbox{\hyperlink{struct_m}{SROffset}} rescale\_offset(\mbox{\hyperlink{struct_s}{SRResolution}} input, \mbox{\hyperlink{struct_z}{SROffsetRational}} rescaler)\{}
\DoxyCodeLine{112     \mbox{\hyperlink{struct_m}{SROffset}} out;}
\DoxyCodeLine{113     out.x = ceil(input.width*rescaler.x.num / rescaler.x.den);}
\DoxyCodeLine{114     out.y = ceil(input.width*rescaler.x.num / rescaler.x.den);}
\DoxyCodeLine{115     \textcolor{keywordflow}{return} out;}
\DoxyCodeLine{116 \}}
\DoxyCodeLine{117 }
\DoxyCodeLine{118 \textcolor{keyword}{static} \textcolor{keywordtype}{void} lock\_thread\_for(\textcolor{keywordtype}{int} sec)\{}
\DoxyCodeLine{119     std::this\_thread::sleep\_for(std::chrono::milliseconds(sec*1000));}
\DoxyCodeLine{120 \}}
\DoxyCodeLine{121 \textcolor{preprocessor}{\#endif }\textcolor{comment}{//SCREENRECLIB\_SRTOOLS\_H}}
